...
describe('getHeroesByPageAction', () => {
  ...
  test('should return first page of heroes', async () => {
    ...
    const firstPage = 1;
    const response = await getHeroesByPageAction(firstPage);
  ...
  test('should return the correct heroes when page is not a number', async () => {
    ...
    await getHeroesByPageAction('one' as unknown as number);
  ...
  test('should return the correct heroes when page param is a string', async () => {
    const responseObject = {
      total: 10,
      pages: 1,
      heroes: []
  ...
  test('should return default response with default params', async () => {
    const responseObject = {
      total: 10,
      pages: 1,
      heroes: []
    ...
    await getHeroesByPageAction(1, 10, 'hero');
